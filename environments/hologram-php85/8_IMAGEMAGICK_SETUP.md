...
```text
extension_dir => /opt/php/8.5.10/lib/php/extensions/debug-zts-20250925 => /opt/php/8.5.10/lib/php/extensions/debug-zts-20250925
```

### configure PHP with imagick

```shell
ls -al /opt/php/8.5.10/lib/php/extensions/debug-zts-20250925
sudo sed -i '$aextension="imagick.so"' /opt/php/8.5.10/lib/php.ini
