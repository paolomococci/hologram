...
```bash
ln --symbolic --verbose /opt/php/8.4.10/bin/php /usr/bin/php
ln --symbolic --verbose /opt/php/8.4.10/bin/phar.phar /usr/bin/phar
ln --symbolic --verbose /opt/php/8.4.10/bin/phpize /usr/bin/phpize
ln --symbolic --verbose /opt/php/8.4.10/bin/php-config /usr/bin/php-config
exit
```
...
wget --spider --https-only https://xdebug.org/files/xdebug-3.4.4.tgz
wget --https-only https://xdebug.org/files/xdebug-3.4.4.tgz
sha256sum xdebug-3.4.4.tgz
...
sudo updatedb
locate xdebug.ini
rnano /opt/php/8.4.10/lib/php.ini
```

First it is a good idea to view the contents of the file without risking causing damage.
And now I edit `/opt/php/8.4.10/lib/php.ini` configuration file

```bash
sudo nano /opt/php/8.4.10/lib/php.ini
```
