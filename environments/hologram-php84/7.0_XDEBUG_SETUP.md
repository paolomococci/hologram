...
```bash
ln --symbolic --verbose /opt/php/8.4.14/bin/php /usr/bin/php
...
sudo updatedb
locate xdebug.ini
rnano /opt/php/8.4.14/lib/php.ini
```

First it is a good idea to view the contents of the file without risking causing damage.
And now I edit `/opt/php/8.4.14/lib/php.ini` configuration file

```bash
sudo nano /opt/php/8.4.14/lib/php.ini
```
