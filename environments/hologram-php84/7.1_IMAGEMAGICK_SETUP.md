...
```text
extension_dir => /opt/php/8.4.21/lib/php/extensions/debug-zts-20240924 => /opt/php/8.4.21/lib/php/extensions/debug-zts-20240924
```

### configure PHP with imagick

```bash
ls -al /opt/php/8.4.21/lib/php/extensions/debug-zts-20240924
sudo sed -i '$aextension="imagick.so"' /opt/php/8.4.21/lib/php.ini
