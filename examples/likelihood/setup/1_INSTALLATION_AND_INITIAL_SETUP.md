...
Web application developed in a LAMP system hosted locally thanks to the GNU/Linux `Ubuntu server 24.04 LTS` distribution.

Procedure for installing Linux servers to be used for the development and production of full-stack web applications.

## install

Attention please, during installation I will deselect the LVM option.
