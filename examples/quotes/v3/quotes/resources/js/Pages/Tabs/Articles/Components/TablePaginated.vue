            ...
            <table class="min-w-full table-auto">
                ...
                <thead class="border-b bg-slate-50">
                    <tr>
                        <th
                            scope="col"
                            class="pl-2 text-sm font-extralight text-left text-slate-400"
                        >
                            #
                        </th>
                        <th
                            scope="col"
                            class="text-sm font-extralight text-left text-slate-600"
                        >
                            title
                        </th>
                        <th
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td
                            ...
                            v-text="article.id"
                            @mouseover="$emit('grabItemIdentifierFromTable', article.id)"
                        ></td>
                        <td
