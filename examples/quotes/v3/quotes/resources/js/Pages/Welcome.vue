...
<template>
    ...
    <div class="text-black/50 dark:text-white/50">
        <div class="bg-gradient-to-tr dark:from-red-800 from-red-400 from-10%  dark:to-slate-800 to-slate-400 to-70%">
            <div
                ...
                <div class="relative px-6 w-full max-w-2xl lg:max-w-7xl">
                    <header class="grid grid-cols-2 gap-2 items-center py-10 lg:grid-cols-3">
                        ...
                        <nav v-if="canLogin" class="flex flex-1 justify-end -mx-3">
                            ...
                            <div
                                class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#f22]/10 sm:size-16 backdrop-blur-sm hover:scale-105">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="stroke-red-800 size-5 sm:size-6">
                            ...
                            <template v-else>
                                ...
                                <div
                                    class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#f22]/10 sm:size-16 backdrop-blur-sm hover:scale-105">
                                    <svg title="Login" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor"
                                        class="stroke-red-800 size-5 sm:size-6">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div
                                    class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#f22]/10 sm:size-16 backdrop-blur-sm hover:scale-105">
                                    <svg title="Register" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor"
                                        class="stroke-red-800 size-5 sm:size-6">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                    ...
                                    <div id="docs-card-content" class="flex gap-6 items-start lg:flex-col">
                                        <div
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                ...
                                                class="stroke-red-600 size-5 sm:size-6">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor"
                                                class="stroke-red-600 size-6 shrink-0">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <a href="https://laracasts.com"
                                class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#f22] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#f22]">
                                <div
                                    class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#f22]/10 sm:size-16">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor"
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Screenshots</h2>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="stroke-red-600 size-6 shrink-0">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                                    </svg>
                                </div>
                            ...
                            <a href="https://laravel-news.com"
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Comments</h2>
                            ...
                            <div
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Ecosystem</h2>
