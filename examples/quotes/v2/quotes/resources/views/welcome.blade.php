...
<head>
    ...
    <style>
        ...
        *,
        ...
        .focus-visible\:ring-\[\#f22\]:focus-visible {
            --tw-ring-opacity: 1;
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .dark\:focus-visible\:ring-\[\#f22\]:focus-visible {
                --tw-ring-opacity: 1;
                --tw-ring-color: rgb(255 45 32 / var(--tw-ring-opacity))
            }
...
<body class="font-sans antialiased dark:bg-black dark:text-white/50 bk-pattern-image">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">

        <img id="background" alt="background" class="absolute -left-20 top-0 max-w-[850px]"
            src="{{ env('APP_URL') }}/img/background.svg" />
        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        <a href="#"
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div class="flex items-start gap-6 lg:flex-col">
                                    <div
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="#f22" class="size-5 sm:size-6">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="#f22" class="size-6 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                    Laravel v{{ Illuminate\Foundation\Application::VERSION }} <a href="{{ env('APP_URL') }}info.php"
                        target="_blank" title="PHP info">(PHP v{{ PHP_VERSION }})</a>
                </footer>
            </div>
        </div>
    </div>
