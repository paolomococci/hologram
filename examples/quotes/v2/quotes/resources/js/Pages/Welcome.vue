                    ...
                    <nav v-if="canLogin" class="flex flex-1 justify-end -mx-3">
                        ...
                        <template v-else>
                            <Link :href="route('login')"
                                class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#f22] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                            <div
                                class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#f22]/10 sm:size-16 backdrop-blur-sm hover:invert hover:scale-105">
                                <svg title="Login" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="2.5" stroke="currentColor" class="stroke-red-800 size-5 sm:size-6">
                            ...
                            <div
                                class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#f22]/10 sm:size-16 backdrop-blur-sm hover:invert hover:scale-105">
                                <svg title="Register" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="2.5" stroke="currentColor" class="stroke-red-800 size-5 sm:size-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                <div id="docs-card-content" class="flex gap-6 items-start lg:flex-col">
                                    <div
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="stroke-red-600 size-5 sm:size-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <a href="#"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="stroke-red-600 size-6 shrink-0">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                            </svg>
                        </a>
