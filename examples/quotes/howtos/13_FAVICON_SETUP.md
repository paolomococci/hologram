...
```bash
scp favicon.ico developer_username@192.168.1.XXX:/var/www/html/quotes/public
```
...
```bash
scp hologram.png developer_username@192.168.1.XXX:/var/www/html/quotes/public
```
