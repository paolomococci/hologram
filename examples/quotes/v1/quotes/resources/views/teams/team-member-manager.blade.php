                ...
                <x-slot name="form">
                    ...
                    @if (count($this->roles) > 0)
                        <div class="col-span-6 lg:col-span-4">
                            ...
                            <div
                                class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer dark:border-gray-700">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                @if ($addTeamMemberForm['role'] == $role->key)
                                                    <svg class="w-5 h-5 text-green-400 ms-2"
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    ...
                                    @if (Gate::check('updateTeamMember', $team) && Laravel\Jetstream\Jetstream::hasRoles())
                                        <button class="text-sm text-gray-400 underline ms-2"
                        ...
                        <div class="{{ $currentRole !== $role->key ? 'opacity-50' : '' }}">
                            ...
                            <div class="flex items-center">
                                ...
                                @if ($currentRole == $role->key)
                                    <svg class="w-5 h-5 text-green-400 ms-2" xmlns="http://www.w3.org/2000/svg"
