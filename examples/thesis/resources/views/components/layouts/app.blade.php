                        ...
                        <div
                            ...
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="text-green-600 dark:text-green-300 lucide lucide-search size-5 sm:size-4 lg:size-6">
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <livewire:view.search placeholder="text to search for" />

                                {{-- TODO: livewire component --}}

                                <p class="mt-4 text-sm/relaxed">
                                    {{-- TODO: eventually documentation text --}}
                                </p>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Article</h2>
