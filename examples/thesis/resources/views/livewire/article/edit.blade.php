<div class="mx-4">
    ...
    <div>
        ...
        <div class="flex mb-3 w-full">
            <button class="flex justify-center items-center p-2 w-1/2 bg-green-300 rounded-sm dark:bg-green-600"
                wire:click="update()" wire:confirm="Are you sure you want to save all the changes you just made?"
                wire:offline.attr="disabled" {{-- wire:dirty.class="hover:bg-gray-800" wire:dirty.remove.attr="disabled" disabled --}}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="text-green-600 dark:text-green-300 lucide lucide-save">
                    <title>update</title>
                    <path
