...
sudo openssl req -new -x509 -days 365 -out /etc/ssl/self_signed_certs/hologram-wp.pem -keyout /etc/ssl/self_signed_certs/hologram-wp.key
ls -al /etc/ssl/self_signed_certs/
sudo chmod 600 /etc/ssl/self_signed_certs/hologram-wp*
...
<IfModule mod_ssl.c>
        <VirtualHost _default_:443>
                ...
                ServerName hologram-wp.local
                ServerAlias www.hologram-wp.local
